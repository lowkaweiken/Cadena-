...
<head>
    ...
    <title>PORT C | Cadena Supply Chain Tracker</title>
    <!-- Bootstrap Core CSS -->
...
$(document).ready(function($){
	...
	//PORT C - Product Delivery Confirmation
	$("#confrimDelivery").on("click",function(){
		var myContract = web3.eth.contract(ABIArray).at(contractAddress);
		myContract.PortC(function(err,result){
...
<body>
	...
	<div class="container-fluid"> 
		<h3>PORT C - Retailer or Shop</h3>
	<button id="confrimDelivery">Confirm Delivery</button>
	<button id="getResult">Get Delivery Status</button>
	<div>Status: 
