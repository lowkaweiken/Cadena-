...
<head>
    ...
    <title>PORT A | Cadena Supply Chain Tracker</title>
    <!-- Bootstrap Core CSS -->
...
$(document).ready(function($){
	...
	$("#submit").on("click",function(){
		...
		//alert(lockStatus);
		if(assetName!="" && assetModel!="" && assetColor!="" && assetID!=""){

			var myContract = web3.eth.contract(ABIArray).at(contractAddress);

			myContract.PortA(assetName,assetModel,assetColor, assetID, assetDesc,lockStatus,function(err,result){
				//Nothing to put here
			});
			

		}else{
			alert("Please fill vacant fields...")
		}
...
<body>
	...
	<div class="container-fluid">
		<h3>PORT A - Farmer or Producer or Factory</h3>
	Asset Name: <input type="text" placeholder="Enter Asset Name" id="assetName"/><br>
	Asset Model: <input type="text" placeholder="Enter Asset Model" id="assetModel"/><br>
	Asset Color: <input type="text" placeholder="Enter Asset Color" id="assetColor"/><br>
	Asset ID: <input type="text" placeholder="Enter Asset ID" id="assetID"/><br>
	Asset Description: <input type="text" placeholder="Enter Asset Description" id="assetDesc"/><br>
	Lock Status: <label><input type="radio" value="yes" name="lockStatus">Yes</label><label><input type="radio" name="lockStatus" value="no">No</label><br>
	<button id="submit">Submit</button>
	
	<button id="getResult">Get Asset Status</button>
	<div>Status: 
